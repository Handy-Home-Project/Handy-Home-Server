...
import com.example.handy_home.presentation.request_dto.InteriorSuggestion;
...
public class InteriorController {
    ...
    public ResponseEntity<ResponseDTO<List<SampleFurnitureDto>>> getSearchSuggestions(@RequestParam("image") MultipartFile image) {
        ...
        List<SampleFurnitureDto> response = sampleFurnitureService.getSuggestionFurnitures(dto.style(), dto.colors());
        return ResponseEntity.ok(ResponseDTO.success(response));
    }

    @PostMapping(value = "/ai_suggestion_interior")
    public ResponseEntity<ResponseDTO<List<SampleFurnitureDto>>> getSearchSuggestions(@RequestBody InteriorSuggestion interiorSuggestion) {
        interiorUseCase.getSuggestionInterior(interiorSuggestion.homeDTO(), interiorSuggestion.sampleFurnitures());
