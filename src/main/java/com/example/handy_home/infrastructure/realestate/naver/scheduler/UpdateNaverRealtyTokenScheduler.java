package com.example.handy_home.infrastructure.realestate.naver.scheduler;

import com.example.handy_home.infrastructure.realestate.naver.NaverRealEstateSearchServiceImpl;
    ...
    private void updateToken() throws InterruptedException {
        ...
        devTools.addListener(Network.requestWillBeSent(), request -> {
            ...
            if (headers.containsKey("authorization")) {
                NaverRealEstateSearchServiceImpl.setNaverRealtyToken((String) headers.get("authorization"));
                latch.countDown();
            }
        });
